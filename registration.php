...
$sql = "INSERT INTO `user_info` (login,password,email) VALUES('$login','$password1','$mail')";
...
if($link->query($sql) === TRUE){
    ?>
<p class="info_registration_yes">
    <?php echo 'запись создана';?>
    <?php
}else{ 
    ?>

<p class="info_registration_no"><?php echo 'логин или mail занят';} $link->close();?></p>
...
<body>
    ...
    <form method="GET" action="phpSearch.php" class="search_registration">
